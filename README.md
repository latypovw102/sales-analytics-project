...
1. `ddl.sql` — создание таблиц базы данных.
2. Файлы с тестовыми данными — загрузка исходных данных в таблицы.
3. `views.sql` — создание аналитических представлений.
4. `segment.sql` — создание логики сегментации клиентов.
5. `zaprosi.sql` — выполнение аналитических SQL-запросов.
6. `otchety.sql` — выполнение запросов для аналитических отчётов.
